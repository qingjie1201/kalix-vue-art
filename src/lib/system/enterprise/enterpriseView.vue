<!--
描述：艺术中心-系统管理-公司信息-查看组件
开发人：hqj
开发日期：2017年12月14日
-->
<template lang="pug">
    kalix-dialog.user-add(bizKey="artCompany" ref="kalixBizDialog" v-bind:formModel.sync="formModel" isView)
        div.el-form.kalix-form-table(slot="dialogFormSlot")
            div.table-title 企业基本信息
            div.s-flex
